...
const RequestAssistance = (props: any) => {
  ...
  const { provinceList, cityList, suburbList, subCategoryList } =
    ...
    switch (step) {
      case 1: {
        if (props.categoryData.categoryId == 1447) {
          ...
          return {
            title: "SUBMIT ITEM",
            desc: "LET US ASSIST IN WHAT YOU LOOKING FOR",
          };
        } else if (props.categoryData.categoryId == 549) {
          return {
            title: "SUBMIT PART IMAGE AND",
            desc: "REQUEST FOR QUOTES, FOR FREE!!",
          };
          ...
          return {
            title: "REQUEST FOR ANY BANKING OR FINANCIAL PRODUCT",
            desc: "HERE, FOR FREE!!",
          };
  ...
  return (
    <div>
      <h3 style={{ marginTop: 100 }}>
        {props.categoryData.categoryId == 1447
          ? "Request Legal Assistance"
          : props.categoryData.categoryId == 1402
          ? "SUBMIT YOUR REQUEST HERE !!"
          : props.categoryData.categoryId == 549
          ? "SUBMIT YOUR REQUEST HERE !!"
          : props.categoryData.categoryId == 1672
          ? "SUBMIT YOUR REQUEST HERE !!"
          : props.categoryData.categoryId == 1396
          ? "SUBMIT YOUR REQUEST HERE !!"
          : props.categoryData.categoryId == 1384
          ? "SUBMIT YOUR REQUEST HERE !!"
          : props.categoryData.categoryId == 1384
          ? "SUBMIT YOUR REQUEST HERE !!"
          : "SUBMIT YOUR REQUEST HERE !!"}
