  ...
  return (
    <div className="fluid-container">
      <Head>
        ...
        <meta
          name="keywords"
          content="Businesses that provides wheels, tyres, mags, wheel; tyre, alloy wheels, mag wheels,Mags, Mag Repairs, Rims, Rim Repairs, New Mags, New Rims, BBS Rims, Eagle Rims, South African Car Parts, Johannesburg, Gauteng, Durban, KwaZulu Natal, Cape, Cape Town, Sandton, Pretoria, East London, Port Elizabeth"
        />
