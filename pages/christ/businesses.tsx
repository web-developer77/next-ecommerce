  ...
  return (
    <div className="fluid-container">
      <Head>
        ...
        <title>Search criteria “Law firms in Province, city, suburb, category” | www.LawyersEzyFind.co.za</title>
        <meta
          name="description"
      ...
      {
categoryId == 1447 &&
<HeroImage title="Attorneys / Lawyers" bgImageUrl="/assets/img/business_list.webp" />
