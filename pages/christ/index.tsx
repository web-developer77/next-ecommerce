  ...
  return (
    <div className="fluid-container">
      <Head>
        ...
        <title>Manufacturing EzyFind | Home</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="South African manufacturers and industral business directory"
        />
      ...
      <HeroImage title="Home" bgImageUrl="/assets/img/manu/magazin_banner.webp" />
      <h1>Upcoming</h1>
    </div>
  )
}
