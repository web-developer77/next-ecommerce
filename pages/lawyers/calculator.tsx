  ...
  return (
    <div className="fluid-container">
      <Head>
        ...
        <meta
          name="description"
          content="Maintenance calculator to calculate income and expenses"
        />
        <meta
          name="keywords"
          content="FREE maintenance calculator, Work out how much should a father pay for maintenance"
        />
      ...
      <HeroImage title="Child Maintenance Calculator" bgImageUrl="/assets/img/lawyer/children_calc_banner.jpg" />
      <CalculatorSection />
    </div>
  )
}
